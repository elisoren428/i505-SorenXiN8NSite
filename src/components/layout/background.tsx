export function Background() {
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 h-[500px] w-[500px] rounded-full bg-[radial-gradient(circle_at_center,hsl(var(--primary)/0.15)_0%,transparent_70%)] opacity-70 blur-3xl transform -translate-x-[40%] -translate-y-1/2"></div>
